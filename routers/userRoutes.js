import { authentication } from "../midlewares/authMidle.js"
...
export class UserRoutes {
    ...
    route() {
        ...
        this.router.patch("/update/:id",(req, res) => this.userController.update(req, res));
        this.router.delete("/delete/:id",(req, res) => this.userController.delete(req, res));
